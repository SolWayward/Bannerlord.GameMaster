    ...
    public static class SaveEquipmentCommand
    {
        ...
        public static string Execute(List<string> args)
        {
            return Cmd.Run(args, () =>
            {
                ...
                EquipmentFileManager.Default.SaveEquipmentToFile(hero, hero.BattleEquipment, filepath, false);
                ...
                result.AppendLine(MessageFormatter.FormatSuccessMessage($"Saved {hero.Name}'s battle equipment to: {Path.GetFileName(filepath)}"));
