...
namespace Bannerlord.GameMaster.Console.CaravanCommands.CaravanManagementCommands
{
    ...
    public static class DisbandNpcLordCaravansCommand
    {
        /// <summary>
        ...
        public static string DisbandNPCLordCaravans(List<string> args)
        {
            return Cmd.Run(args, () =>
            {
                ...
                string argumentDisplay = parsed.FormatArgumentDisplay("gm.caravan.disband_npc_lord_caravans", resolvedValues);
